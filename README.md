...
1. [Objective-C](https://developer.apple.com/library/archive/documentation/Cocoa/Conceptual/ProgrammingWithObjectiveC/Introduction/Introduction.html#//apple_ref/doc/uid/TP40011210-CH1-SW1)

2. [Swift](https://swiftgg.gitbook.io/swift/)
...
* 逆向
    ...
    - 逆向程序开发工具
    > [frida](https://github.com/frida)是一款基于Python+java的hook框架，可运行在android/iOS/linux/windosx等各平台，主要使用动态二进制插桩技术。
    ...
    >> 2.1 静态二进制插桩：在程序执行前插入额外的代码和数据，生成一个永久改变的可执行文件。
    
    >> 2.2 动态二进制插桩：在程序运行时实时地插入额外代码和数据，对可执行文件没有任何永久改变。
    - 反汇编工具
    - 调试器
...
* App Services
    ...
    - [CareKit](https://developer.apple.com/documentation/carekit)
    ...
    - [QuickLookThumbnailing](https://developer.apple.com/documentation/quicklookthumbnailing)
    - [SafariServices](https://developer.apple.com/documentation/safariservices)
    - [SiriKit](https://developer.apple.com/documentation/safariservices)
...
* Media
    ...
    - [Apple Search Ads](https://developer.apple.com/documentation/apple_search_ads)
...
* Developer Tools
    ...
    - [Installer JS](https://developer.apple.com/documentation/installerjs)
    ...
    - [xcselect](https://developer.apple.com/documentation/xcselect)
    - [XCTest](https://developer.apple.com/documentation/xctest)
...
* System
    ...
    - [ExecutionPolicy](https://developer.apple.com/documentation/executionpolicy)
    ...
    - [SerialDriverKit](https://developer.apple.com/documentation/serialdriverkit)
